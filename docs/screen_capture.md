...
`docs/reference/repos/gnome-shell` for reference): `screenshot` and `screenshot-window` both
...
directly (`flameshot-org/flameshot`, cloned into `docs/reference/repos/flameshot`), not its docs.

...
No code changes accompany this plan. Next step, whenever picked back up, is a real planning session
for whichever piece comes first — most likely §A, given it's the smaller, lower-risk,

...
# TODO: Add key to GitLab
# <https://docs.gitlab.com/ee/api/deploy_keys.html>
#

# User API token can be found: "https://gitlab.com/profile/account"
GITHUB_API_TOKEN="m3iP27Jh8KSgNmWAksYp"
# TODO: see how to use password auth
